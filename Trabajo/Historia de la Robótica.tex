...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%       Teoría de Autómatas, Automatización e Inteligencia Artificial        %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{./TeoriaDeAutomatas/introduccion.tex}

%Conceptualizacion de la máquina y el autómata
\subsection{Conceptualización de la máquina y el autómata}
\input{./TeoriaDeAutomatas/conceptualizacion_maquina_automata.tex}

%Autómatas finitos
\subsection{Autómatas finitos}
\input{./TeoriaDeAutomatas/automatas_finitos.tex}

%La jerarquía de Chomsky
\subsection{La jerarquía de Chomsky}
\input{./TeoriaDeAutomatas/jerarquia_chomsky.tex}

%La Máquina de Turing
\subsection{La Máquina de Turing}
\input{./TeoriaDeAutomatas/maquina_turing.tex}

%Inteligencia Artificial
\subsection{Inteligencia Artificial}
\input{./TeoriaDeAutomatas/inteligencia_artificial.tex}

%Fronteras
\subsection{Fronteras}
\input{./TeoriaDeAutomatas/fronteras.tex}
...
%Definición y Descripción de un Robot
\subsection{Definición y Descripción de un Robot}
\input{./EtapaPrimeriza/definicion_descripcion_robot.tex}

%Orígenes de la Robótica (Griegos)
\subsection{Orígenes de la Robótica (Griegos)}
\input{./EtapaPrimeriza/origenes_robotica_griegos.tex}

%Sistemas Mecánicos Simples
\subsection{Sistemas Mecánicos Simples}
\input{./EtapaPrimeriza/sistemas_mecanicos_simples.tex}

%Leonardo da Vinci
\subsection{Leonardo da Vinci}
\input{./EtapaPrimeriza/leonardo_da_vinci.tex}

%Máquina Calculadora de Pascal
\subsection{Máquina Calculadora de Pascal}
\input{./EtapaPrimeriza/maquina_calculadora_pascal.tex}

%Isaac Asimov y las reglas de la robótica
\subsection{Isaac Asimov y las reglas de la robótica}
\input{./EtapaPrimeriza/reglas_robotica.tex}

%Tortugas autónomas de Walter
\subsection{Tortugas autónomas de Walter}
\input{./EtapaPrimeriza/tortugas_autonomas.tex}

%El brazo robótico teleoperado de Goertz
\subsection{El brazo robótico teleoperado de Goertz}
\input{./EtapaPrimeriza/brazo_robotico_goertz.tex}

%Autónoma Universal de George Devol
\subsection{Autónoma Universal de George Devol}
\input{./EtapaPrimeriza/autonoma_universal_devol.tex}

%Sputnik
\subsection{Sputnik}
\input{./EtapaPrimeriza/sputnik.tex}

%Robots Industriales de Generals Motors
\subsection{Robots Industriales de General Motors}
\input{./EtapaPrimeriza/robots_industriales_general_motors.tex}

\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                       Historia Moderna de la Robótica                      %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
